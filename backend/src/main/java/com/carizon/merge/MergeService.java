        ...
        while (true) {
            ...
            inTxWithNamedLock(lockName, () -> {
                ...
                String sql = """
                    ...
                    CAST(NULLIF(TRIM(REPLACE(CAST(r.sell_price AS CHAR), ',', '')), '' ) AS DECIMAL(18,0),
                    CAST(NULLIF(TRIM(REPLACE(CAST(r.mileage AS CHAR), ',', '')), '' ) AS DECIMAL(18,0),
                    CAST(NULLIF(TRIM(REPLACE(CAST(r.displacement AS CHAR), ',', '')), '' ) AS DECIMAL(18,0),
