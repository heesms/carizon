...
import { dataApi, CarMaster, PlatformCar } from '../api/data'
                ...
                <Space direction="vertical" size="large" style={{ width: '100%' }}>
                  ...
                  <Table
                    ...
                    pagination={{
                      ...
                      onChange: (page, size) => {
                        setCarMasterParams({ ...carMasterParams, page: page - 1, size })
                      },
                    }}
                    scroll={{ x: 1500 }}
                  />
                ...
                <Space direction="vertical" size="large" style={{ width: '100%' }}>
                  ...
                  <Table
                    ...
                    pagination={{
                      ...
                      onChange: (page, size) => {
                        setPlatformCarParams({ ...platformCarParams, page: page - 1, size })
                      },
                    }}
                    scroll={{ x: 1800 }}
                  />
