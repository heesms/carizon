    ...
    <div className="min-h-screen min-h-[100dvh] flex flex-col">
      ...
      <nav className="sm:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200"
        ...
        <div className="flex items-stretch h-14">
          ...
          <NavLink to="/" end className={bottomNavCls} onClick={clearSearchScrollMemory}>
          ...
          <NavLink to="/search" className={bottomNavCls} onClick={clearSearchScrollMemory}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
          ...
          <NavLink to="/recommendation" className={bottomNavCls} onClick={clearSearchScrollMemory}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
          ...
          <NavLink to="/ai-ranking" className={bottomNavCls} onClick={clearSearchScrollMemory}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
          ...
          <NavLink to="/likes" className={bottomNavCls} onClick={clearSearchScrollMemory}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
