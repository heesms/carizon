...
import { searchApi, SearchTestParams } from '../../api/admin/search'
  ...
  return (
    <div>
      ...
      <Space direction="vertical" size="large" style={{ width: '100%' }}>
        <Card title="인덱싱 실행">
          <Space>
            ...
            <Button
              ...
              onClick={() => incrementalIndexMutation.mutate(undefined)}
              loading={incrementalIndexMutation.isPending}
            >
              증분 인덱싱 (최근 1시간)
            </Button>
            <Button
              onClick={() => batchIndexMutation.mutate(1000)}
        ...
        <Card title="검색 테스트">
          <Form form={searchForm} layout="inline" onFinish={handleTestSearch} style={{ marginBottom: 16 }}>
            ...
            <Form.Item>
              <Button type="primary" htmlType="submit" icon={<SearchOutlined />} loading={testSearchMutation.isPending}>
                검색 테스트
              </Button>
            </Form.Item>
          </Form>
          ...
          {testResult && (
            <>
              ...
              <Space direction="vertical" style={{ width: '100%' }}>
                <div><strong>검색 결과:</strong> 총 {testResult.total || 0}건</div>
                <Table
                  columns={testColumns}
